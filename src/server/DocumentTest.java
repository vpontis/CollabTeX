...
public class DocumentTest {
	...
	public void testSingleParagraphDocument() {
		Document testingDocument = new Document("123", "Test1"); //Initialize a new document with a fake document ID
	...
	public void testMultipleParagraphDocument() {
		Document testingDocument = new Document("123", "Test2"); //Initialize a new document with a fake document ID
